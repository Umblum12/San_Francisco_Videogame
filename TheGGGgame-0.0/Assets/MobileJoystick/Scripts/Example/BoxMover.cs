...
namespace DitzeGames.MobileJoystick.Example
{
	...
	void Update () {
        ...
        transform.position = new Vector3(transform.position.x + Joystick.AxisNormalized.x * Time.deltaTime * 100f, Button.Pressed ? 2 : 1, transform.position.z + Joystick.AxisNormalized.y * Time.deltaTime * 100f);
